...
function rellenarCruceMFO() { //Llamada a la API según el dato obtenido del primer combo
    var url = 'http://172.27.120.120/gestin/public/api/radar'
    fetch(url, {
            method: 'GET',
            headers: {
...
async function nuevoMFO() {
    ...
    if (idInstalacion.value != "") {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/mforadar/nueva';
...
console.log(cruceFil);

    var url = 'http://172.27.120.120/gestin/public/api/mforadar/'+ id;
    fetch(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
...
async   function borrarMFO(id) {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/mforadar/borrar/'+id;
   await     fetch(url, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
...
async function editarMFO(param) {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mforadar/modificar/' + param;
...
async function imprimir() {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mforadar/imprimir/' + mes +'/'+año;
    ...
    var url2 = 'http://172.27.120.120/gestin/public/api/mforadar/imprimir/fechainspeccion/' + mes +'/'+año;
    ...
    col=[
        {header: 'Cámara', dataKey: 'idInstalacion'},
    ...
    doc.setFontSize(22);
    doc.text("MFO de Radar / Foto Rojo",14,20);
    ...
    doc.setFontSize(10);
    doc.text("Precio Total: "+ precioTotal.toFixed(2) + "€",14,doc.autoTable.previous.finalY+8);
...
async function imprimirNoOk() {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mforadar/imprimirnook/' + mes +'/'+año;
    var listado= await fetch(url, {
                                    method: 'GET',
                                    headers: {
                                        'Content-Type': 'application/json'
    ...
    var url2 = 'http://172.27.120.120/gestin/public/api/mforadar/imprimirnook/fechainspeccion/' + mes +'/'+año;
    ...
    doc.setFontSize(22);
    doc.text("MFO de Radar No Ok",14,20);
...
function rellenarPrecio2(id) {
    ...
    fetch(url, {
        ...
        .then(response => {
            ...
            p.value=response[0]['preciomforadar'];
