...
activo = String(activo);
        ...
        var url = 'http://172.27.120.120/gestin/public/api/11_200/nueva';
...
function rellenarTodos11_200() { //Llamada a la API  //CAMBIO DE NOMENCLATURA
    var idInstalacion = document.getElementById('inputInstalacion').value;
    var url = 'http://172.27.120.120/gestin/public/api/11_200/' + idInstalacion
    fetch(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
...
function rellenarFooter11_200(){//CAMBIO DE NOMENCLATURA
    var idInstalacion = document.getElementById('inputInstalacion').value;
    var url = 'http://172.27.120.120/gestin/public/api/11_200/activas/' + idInstalacion
    fetch(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
...
function borrar11_200(param) {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/11_200/borrar/' + param
    fetch(url, {
            method: 'DELETE'
...
function editar11_200(param) {//CAMBIO DE NOMENCLATURA
    ...
    var url = 'http://172.27.120.120/gestin/public/api/11_200/modificar/' + param;
...
function comprobarNumSerie11_200() {
    ...
    if (idNumSerie) {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/numserierepetidos/11_200/' + idNumSerie;
        fetch(url, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
...
function comprobarNumSerie11_2002() {
    ...
    if (idInstalacion) {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/numserierepetidos/11_200';
        fetch(url, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
