...
function comprobarNumSerie12_pea_bici() {
    ...
    if (idNumSerie) {
        ...
        var url = 'http://172.27.120.111/gestin/public/api/numserierepetidos/12_pea_bici/' + idNumSerie;
        fetch(url, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
...
function comprobarNumSerie12_pea_bici2() {
    ...
    if (idInstalacion) {
        ...
        var url = 'http://172.27.120.111/gestin/public/api/numserierepetidos/12_pea_bici';
        fetch(url, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
