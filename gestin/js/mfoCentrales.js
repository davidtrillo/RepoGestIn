...
function rellenarCruceMFO() { //Llamada a la API según el dato obtenido del primer combo
    var url = 'http://172.27.120.120/gestin/public/api/mfocentrales'
    fetch(url, {
            method: 'GET',
            headers: {
...
async function nuevoMFO() {
    ...
    if (idInstalacion.value != "") {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/mfoCentrales/nueva';
...
function filtrarCruce(id) {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfoCentrales/'+ id;
    fetch(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
...
async   function borrarMFO(id) {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/mfoCentrales/borrar/'+id;
   await     fetch(url, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
...
async function editarMFO(param) {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfoCentrales/modificar/' + param;
...
async function imprimir() {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfoCentrales/imprimir/' + mes +'/'+año;
    ...
    var url2 = 'http://172.27.120.120/gestin/public/api/mfoCentrales/imprimir/fechainspeccion/' + mes +'/'+año;
    ...
    doc.setFontSize(22);
    doc.text("MFO de Centrales",14,20);
...
async function imprimirNoOk() {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfoCentrales/imprimirnook/' + mes +'/'+año;
    var listado= await fetch(url, {
                                    method: 'GET',
                                    headers: {
                                        'Content-Type': 'application/json'
    ...
    var url2 = 'http://172.27.120.120/gestin/public/api/mfoCentrales/imprimirnook/fechainspeccion/' + mes +'/'+año;
    ...
    doc.setFontSize(22);
    doc.text("MFO de Centrales No Ok",14,20);
 ...
 function rellenarPrecio2(id) {
    ...
    fetch(url, {
        ...
        .then(response => {
            ...
            p.value=response[0]['preciomfocentral'];
