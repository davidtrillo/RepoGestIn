...
activo = String(activo);
        ...
        var url = 'http://172.27.120.120/gestin/public/api/13_332/nueva';
    ...
    fetch(url, {
        ...
        .then(response => {
            ...
            for (var i in response) {
                ...
                if (str.substring(9,14)=='13332'){// CAMBIAR TIPO DE CARCASA
                p.innerHTML += `
...
function rellenarTipoActuacion213_332(descripcionTipoActuacion, idActuacion) { //CAMBIO DE NOMENCLATURA
...
function rellenarTodos13_332() { //Llamada a la API  //CAMBIO DE NOMENCLATURA
    var idInstalacion = document.getElementById('inputInstalacion').value;
    var url = 'http://172.27.120.120/gestin/public/api/13_332/' + idInstalacion
    fetch(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
...
function rellenarFooter13_332(){//CAMBIO DE NOMENCLATURA
    var idInstalacion = document.getElementById('inputInstalacion').value;
    var url = 'http://172.27.120.120/gestin/public/api/13_332/activas/' + idInstalacion
    fetch(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
...
function borrar13_332(param) {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/13_332/borrar/' + param
    fetch(url, {
            method: 'DELETE'
...
function editar13_332(param) {//CAMBIO DE NOMENCLATURA
    ...
    var url = 'http://172.27.120.120/gestin/public/api/13_332/modificar/' + param;
...
function comprobarNumSerie13_332() {
    ...
    if (idNumSerie) {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/numserierepetidos/13_332/' + idNumSerie;
        fetch(url, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
...
function comprobarNumSerie13_3322() {
    ...
    if (idInstalacion) {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/numserierepetidos/13_332';
        fetch(url, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
