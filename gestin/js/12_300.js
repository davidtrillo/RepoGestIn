...
function leerTipoActuacion12_300(descripcionTipoActuacion, idTipoActuacion) { //CAMBIO DE NOMENCLATURA
             ...
             <div class="row ml-1" id="">
                 ...
                 <div class="col-2 mt-1 pl-0" >
                        <div class="input-group">
                            <button type="button" class="btn btn-secondary dropdown-toggle" name="btnTipoActuacion${response[i]['id']}" value="${response[i]['id']}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onclick="rellenarTipoActuacion212_300(this.value)">
                                    Tipo A.
                            </button>
