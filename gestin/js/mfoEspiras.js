...
function rellenarCruceMFO() { //Llamada a la API según el dato obtenido del primer combo
    var url = 'http://172.27.120.111/gestin/public/api/tespiras'
    fetch(url, {
            method: 'GET',
            headers: {
...
async function nuevoMFO() {
    ...
    if (idInstalacion.value != "") {
        ...
        var url = 'http://172.27.120.111/gestin/public/api/mfoespiras/nueva';
...
function rellenarMFO() {
    ...
    var url = 'http://172.27.120.111/gestin/public/api/mfoespiras/espiras'
    fetch(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
...
function borrarMFO(id) {
        ...
        var url = 'http://172.27.120.111/gestin/public/api/mfoespiras/borrar/'+id;
        fetch(url, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
...
function editarMFO(param) {
    ...
    var url = 'http://172.27.120.111/gestin/public/api/mfoespiras/modificar/' + param;
...
async function imprimir() {
    ...
    var url = 'http://172.27.120.111/gestin/public/api/mfoespiras/imprimir/' + mes +'/'+año;
