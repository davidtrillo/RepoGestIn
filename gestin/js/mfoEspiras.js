...
async function nuevoMFO() {
    ...
    if (idInstalacion.value != "") {
        ...
        var url = 'http://webserver.mobilitat.local/gestin/public/api/mfoespiras/nueva';
...
function borrarMFO(id) {
        ...
        var url = 'http://webserver.mobilitat.local/gestin/public/api/mfoespiras/borrar/'+id;
        fetch(url, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
...
function editarMFO(param) {
    ...
    var url = 'http://webserver.mobilitat.local/gestin/public/api/mfoespiras/modificar/' + param;
...
async function imprimir() {
    ...
    var url = 'http://webserver.mobilitat.local/gestin/public/api/mfoespiras/imprimir/' + mes +'/'+año;
