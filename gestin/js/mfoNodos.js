...
function rellenarCruceMFO() { //Llamada a la API según el dato obtenido del primer combo
    var url = 'http://172.27.120.120/gestin/public/api/nodos'
    fetch(url, {
            method: 'GET',
            headers: {
...
async function nuevoMFO() {
    ...
    if (idInstalacion.value != "") {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/mfonodos/nueva';
...
console.log(cruceFil);
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfonodos/'+ id;
    fetch(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
...
async   function borrarMFO(id) {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/mfonodos/borrar/'+id;
   await     fetch(url, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
...
async function editarMFO(param) {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfonodos/modificar/' + param;
...
async function imprimir() {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfonodos/imprimir/' + mes +'/'+año;
    ...
    var url2 = 'http://172.27.120.120/gestin/public/api/mfonodos/imprimir/fechainspeccion/' + mes +'/'+año;
...
async function imprimirNoOk() {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfonodos/imprimirnook/' + mes +'/'+año;
    var listado= await fetch(url, {
                                    method: 'GET',
                                    headers: {
                                        'Content-Type': 'application/json'
    ...
    var url2 = 'http://172.27.120.120/gestin/public/api/mfonodos/imprimirnook/fechainspeccion/' + mes +'/'+año;
    ...
    doc.setFontSize(22);
    doc.text("MFO de Nodos No Ok",14,20);
...
function rellenarPrecio2(id) {
    ...
    fetch(url, {
        ...
        .then(response => {
            ...
            p.value=response[0]['preciomfonodo'];
