...
console.log(activo);
        ...
        var url = 'http://172.27.120.111/gestin/public/api/12_200/nueva';
...
function form12_200() { //CAMBIO DE NOMENCLATURA
    ...
    if (instalacion.value != "") {
        ...
        `
        rellenarTipoActuacion12_200();//CAMBIO DE NOMENCLATURA
...
function rellenarTodos12_200() { //Llamada a la API  //CAMBIO DE NOMENCLATURA
    var idInstalacion = document.getElementById('inputInstalacion').value;
    var url = 'http://172.27.120.111/gestin/public/api/12_200/' + idInstalacion
    fetch(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
...
function rellenarFooter12_200(){//CAMBIO DE NOMENCLATURA
    var idInstalacion = document.getElementById('inputInstalacion').value;
    var url = 'http://172.27.120.111/gestin/public/api/12_200/activas/' + idInstalacion
    fetch(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
...
function borrar12_200(param) {
    ...
    var url = 'http://172.27.120.111/gestin/public/api/12_200/borrar/' + param
    fetch(url, {
            method: 'DELETE'
...
function editar12_200(param) {//CAMBIO DE NOMENCLATURA
    ...
    var url = 'http://172.27.120.111/gestin/public/api/12_200/modificar/' + param;
...
function comprobarNumSerie() {
    ...
    if (idNumSerie) {
        ...
        var url = 'http://172.27.120.111/gestin/public/api/numserierepetidos/12_200/' + idNumSerie;
        fetch(url, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
...
function comprobarNumSerie2() {
    ...
    if (idInstalacion) {
        ...
        var url = 'http://172.27.120.111/gestin/public/api/numserierepetidos/12_200';
        fetch(url, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
