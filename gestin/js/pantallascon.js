function nuevaPantallasCon() { //CAMBIO DE NOMENCLATURA
    ...
    if (idInstalacion.value != "") {
        ...
        if (validarFormatoFechaPantallasCon(fechaActuacion)) { //CAMBIO DE NOMENCLATURA
            if (existeFechaPantallasCon(fechaActuacion)) { //CAMBIO DE NOMENCLATURA
...
function validarFormatoFechaPantallasCon(campo) { //CAMBIO DE NOMENCLATURA
...
function existeFechaPantallasCon(fecha) { //CAMBIO DE NOMENCLATURA
...
function existeFecha2PantallasCon(fecha) { //CAMBIO DE NOMENCLATURA
    var fechaf = fecha.split("/");
    var d = fechaf[2];
    var m = fechaf[1];
    var y = fechaf[0];
        ...
        .then(response => {
            if (response == "No se han encontrado resultados") {
             ...
             <div class="row ml-0 pl-0" id="">
                 ...
                 <div class="col-1 pl-0">
                    <div class="btn btn-primary" id="${response[i]['id']}" onclick="editarPantallasCon(this.id)" title="Guardar edición"><i class="fas fa-pencil-alt"></i></div>
                    <div class="btn btn-danger" title="Eliminar registro" id="${response[i]['id']}" onclick="borrarPantallasCon(this.id)"><i class="fas fa-trash-alt"></i></div>
                 </div>
...
function editarPantallasCon(param) {//CAMBIO DE NOMENCLATURA
    ...
    //validar fecha correcta
    if (validarFormatoFechaPantallasCon(inputFechaActuacionTar)) {
        if (existeFechaPantallasCon(inputFechaActuacionTar)) {
