...
async function nuevoMFO() {
    ...
    if (idInstalacion.value != "") {
        ...
        var url = 'http://webserver.mobilitat.local/gestin/public/api/mfopp/nueva';
...
function borrarMFO(id) {
        ...
        var url = 'http://webserver.mobilitat.local/gestin/public/api/mfopp/borrar/'+id;
        fetch(url, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
...
async function imprimir() {
    ...
    var url = 'http://webserver.mobilitat.local/gestin/public/api/mfopp/imprimir/' + mes +'/'+año;
