    ...
    fetch(url, {
        ...
        .then(response => {
            ...
            for (var i in response) {
                ...
                if (str.substring(9,14)=='11300'){// CAMBIAR TIPO DE CARCASA
                p.innerHTML += `
...
function escribirTipoActuacion11_300(descripcionTipoActuacion, idTipoActuacion) { //CAMBIO DE NOMENCLATURA
...
async function form11_300(elemento) { //CAMBIO DE NOMENCLATURA
    ...
    tipoActuacion.forEach(function(value,index){ //recorrer la matriz de la tabla en tablas.js
        tipo += '<button class="dropdown-item" type="submit" value="'+ value +'" onclick="escribirTipoActuacion11_300(this.value)" >'+ value +'</button>';
    ...
    if (instalacion.value != "") {
        ...
        `
    // await rellenarTipoActuacion11_300();
