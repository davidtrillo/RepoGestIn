...
function nuevaPintura() {
    ...
    if (idInstalacion.value != "") {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/pintura/nueva';
...
//function rellenarPintura() {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/pintura/'+cruceFil
    fetch(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
...
function getElementos(id) {
     ...
     var url = 'http://172.27.120.120/gestin/public/api/elementospintura/'+id;
     fetch(url, {
             method: 'GET',
             headers: {
                 'Content-Type': 'application/json'
...
function borrarPintura(id) {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/pintura/borrar/'+id;
        fetch(url, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
...
function editarPintura(param) {//CAMBIO DE NOMENCLATURA
    ...
    var url = 'http://172.27.120.120/gestin/public/api/pintura/modificar/' + param;
