...
function rellenarCruceMFO() { //Llamada a la API según el dato obtenido del primer combo
    var url = 'http://172.27.120.120/gestin/public/api/camaras'
    fetch(url, {
            method: 'GET',
            headers: {
...
function leerCruceMFO3(id,ubicacion) {
    var p1 = document.getElementById('inputIdCamara');
...
async function nuevoMFO() {
    ...
    if (idInstalacion.value != "") {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/mfoCamaras/nueva';
...
function filtrarCruce(id) {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfoCamaras/camaras/'+ id;
    fetch(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
...
async   function borrarMFO(id) {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/mfoCamaras/borrar/'+id;
   await     fetch(url, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
...
async function editarMFO(param) {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfoCamaras/modificar/' + param;
...
async function imprimir() {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfoCamaras/imprimir/' + mes +'/'+año;
    ...
    var url2 = 'http://172.27.120.120/gestin/public/api/mfoCamaras/imprimir/fechainspeccion/' + mes +'/'+año;
...
async function imprimirNoOk() {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfoCamaras/imprimirnook/' + mes +'/'+año;
    var listado= await fetch(url, {
                                    method: 'GET',
                                    headers: {
                                        'Content-Type': 'application/json'
    ...
    var url2 = 'http://172.27.120.120/gestin/public/api/mfoCamaras/imprimirnook/fechainspeccion/' + mes +'/'+año;
    ...
    doc.setFontSize(22);
    doc.text("MFO de Cámaras No Ok",14,20);
 ...
 function rellenarPrecio2(id) {
    ...
    fetch(url, {
        ...
        .then(response => {
            ...
            p.value=response[0]['preciomfocamara'];
