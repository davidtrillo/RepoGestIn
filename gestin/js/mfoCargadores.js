...
function rellenarCruceMFO() { //Llamada a la API según el dato obtenido del primer combo
    var url = 'http://172.27.120.120/gestin/public/api/cargadores'
    fetch(url, {
            method: 'GET',
            headers: {
...
function rellenarCruceMFOFiltro() { //Llamada a la API según el dato obtenido del primer combo
    ...
    fetch(url, {
        ...
        .catch(error => console.error('Error:', error))
        .then(response => {
            var p = document.getElementById('dropCargadores');
            p.innerHTML = '';
            for (var i in response) {
                p.innerHTML += `
...
function leerCruceMFO3(id,ubicacion) {
    var p1 = document.getElementById('inputIdCargadores');
...
async function nuevoMFO() {
    ...
    if (idInstalacion.value != "") {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/mfocargadores/nueva';
...
function filtrarCruce(id) {
    ...
    var cruceFil = document.getElementById('inputIdCargadores').value;


    var url = 'http://172.27.120.120/gestin/public/api/mfocargadores/cargadores/'+id;
    fetch(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
...
function rellenarUbicacion(param) {
 ...
 async function borrarMFO(id) {
        ...
        var url = 'http://172.27.120.120/gestin/public/api/mfocargadores/borrar/'+id;
  await      fetch(url, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
...
async function editarMFO(param) {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfocargadores/modificar/' + param;
...
async function imprimir() {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfocargadores/imprimir/' + mes +'/'+año;
    ...
    var url2 = 'http://172.27.120.120/gestin/public/api/mfocargadores/imprimir/fechainspeccion/' + mes +'/'+año;
...
async function imprimirNoOk() {
    ...
    var url = 'http://172.27.120.120/gestin/public/api/mfocargadores/imprimirnook/' + mes +'/'+año;
    var listado= await fetch(url, {
                                    method: 'GET',
                                    headers: {
                                        'Content-Type': 'application/json'
    ...
    var url2 = 'http://172.27.120.120/gestin/public/api/mfocargadores/imprimirnook/fechainspeccion/' + mes +'/'+año;
    ...
    doc.setFontSize(22);
    doc.text("MFO de Cargadores No Ok",14,20);
    ...
    if (c.checked){
        ...
        fetch(url, {
            ...
            .then(response => {
                ...
                p.value=response[0]['preciomfocargador'];
