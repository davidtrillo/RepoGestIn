...
<body>
      ...
      <div class="row">
         ...
         <div class="col">
            <div class="input-group ">
               ...
               <input type="text" class="form-control bg-warning " name="" id="inputIdCamara" value="">
  ...
  <div class="modal-dialog modal-lg" role="document">
   ...
   <script src="../js/mfoCamaras.js"></script>
