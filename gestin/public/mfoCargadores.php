...
<body>
      ...
      <div class="row"> 
         ...
         <div class="col">
              <div class="input-group ">
               ...
               <div class="dropdown-menu" id="dropCargadores">
                  <!-- inyectar código -->
               </div>
               <input type="text" class="form-control bg-warning " name="" id="inputIdCargadores" value="">
   ...
   <script src="../js/mfoCargadores.js"></script>
