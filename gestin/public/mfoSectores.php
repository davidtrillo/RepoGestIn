...
<body>
      ...
      <div class="row">
         ...
         <div class="col">
              <div class="input-group ">
               ...
               <input type="text" class="form-control bg-warning " name="" id="inputIdCruce" value="">
            ...
            <div class="col-1 p-1">
               ...
               <div class="input-group mt-2">
                <!--  <button type="button" class="btn btn-secondary dropdown-toggle" name="" value=""
                  ...
                  <input type="text" class="form-control" name="" id="inputIdCruce2" value="" disabled>
   ...
   <script src="../js/mfoSectores.js"></script>
