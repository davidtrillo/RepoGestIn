...
//POST para modificar instalacion UPDATE BY ID
 ...
 $app->get('/api/mfocargadores/imprimir/{a}/{b}',function(Request $request, Response $response){
    ...
    $sql='SELECT idInstalacion, i.ubicacion, fechaActuacion, fechaInspeccion, observaciones, precio FROM mfocargadores m JOIN instalaciones i ON m.idInstalacion=i.id WHERE resolucion="true" and month(m.fechaactuacion)="'.$mes.'" AND year(m.fechaactuacion)="'.$año.'" order by 1';
...
$app->get('/api/mfocargadores/imprimirnook/{a}/{b}',function(Request $request, Response $response){
    $mes= $request->getAttribute('a');
    $año= $request->getAttribute('b');

    $sql='SELECT idInstalacion, i.ubicacion, fechaActuacion, fechaInspeccion, observaciones, precio FROM mfocargadores m JOIN instalaciones i ON m.idInstalacion=i.id WHERE resolucion="false" and month(m.fechaactuacion)="'.$mes.'" AND year(m.fechaactuacion)="'.$año.'" order by 1';
    //$sql='SELECT idInstalacion, i.ubicacion, fechaActuacion, observaciones, precio FROM mfo m JOIN instalaciones i ON m.idInstalacion=i.id WHERE month(m.fechaactuacion)="9" AND year(m.fechaactuacion)="2019"';
...
$app->get('/api/mfocargadores/imprimirnook/fechainspeccion/{a}/{b}',function(Request $request, Response $response){
    $mes= $request->getAttribute('a');
    $año= $request->getAttribute('b');

    $sql='SELECT count(fechaInspeccion) FROM mfocargadores m JOIN instalaciones i ON m.idInstalacion=i.id WHERE resolucion="false" and month(m.fechaactuacion)="'.$mes.'" AND year(m.fechaactuacion)="'.$año.'" order by 1';
    //$sql='SELECT idInstalacion, i.ubicacion, fechaActuacion, observaciones, precio FROM mfo m JOIN instalaciones i ON m.idInstalacion=i.id WHERE month(m.fechaactuacion)="9" AND year(m.fechaactuacion)="2019"';
...
$app->get('/api/mfocargadores/imprimir/fechainspeccion/{a}/{b}',function(Request $request, Response $response){
    $mes= $request->getAttribute('a');
    $año= $request->getAttribute('b');

    $sql='SELECT count(fechaInspeccion) FROM mfocargadores m JOIN instalaciones i ON m.idInstalacion=i.id WHERE resolucion="true" and month(m.fechaactuacion)="'.$mes.'" AND year(m.fechaactuacion)="'.$año.'" order by 1';
    //$sql='SELECT idInstalacion, i.ubicacion, fechaActuacion, observaciones, precio FROM mfo m JOIN instalaciones i ON m.idInstalacion=i.id WHERE month(m.fechaactuacion)="9" AND year(m.fechaactuacion)="2019"';
