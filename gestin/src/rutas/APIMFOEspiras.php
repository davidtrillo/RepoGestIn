...
$app->get('/api/tespiras',function(Request $request, Response $response){
    // echo "todas las instalaciones";
    $sql='SELECT id, ubicacion FROM instalaciones where tipoInstalacion LIKE "PUNTO%" ORDER BY cont';
    try{
        $db= new db();     
        $db=$db->conectDB();
...
//POST para modificar instalacion UPDATE BY ID
 ...
 $app->get('/api/mfoespiras/imprimir/{a}/{b}',function(Request $request, Response $response){
    $mes= $request->getAttribute('a');
    $año= $request->getAttribute('b');

    $sql='SELECT idInstalacion, i.ubicacion, fechaActuacion, fechaInspeccion, observaciones, precio FROM mfoespiras m JOIN instalaciones i ON m.idInstalacion=i.id WHERE resolucion="true" and month(m.fechaactuacion)="'.$mes.'" AND year(m.fechaactuacion)="'.$año.'" order by 1';
...
$app->get('/api/mfoespiras/suma/{a}/{b}',function(Request $request, Response $response){
    $mes= $request->getAttribute('a');
    $año= $request->getAttribute('b');

    $sql='SELECT sum(precio) FROM mfoespiras WHERE resolucion="true" and month(fechaactuacion)="'.$mes.'" AND year(fechaactuacion)="'.$año.'"';
    //$sql='SELECT idInstalacion, i.ubicacion, fechaActuacion, observaciones, precio FROM mfo m JOIN instalaciones i ON m.idInstalacion=i.id WHERE month(m.fechaactuacion)="9" AND year(m.fechaactuacion)="2019"';
...
$app->get('/api/mfoespiras/imprimirnook/{a}/{b}',function(Request $request, Response $response){
    $mes= $request->getAttribute('a');
    $año= $request->getAttribute('b');

    $sql='SELECT idInstalacion, i.ubicacion, fechaActuacion, fechaInspeccion, observaciones, precio FROM mfoespiras m JOIN instalaciones i ON m.idInstalacion=i.id WHERE resolucion="false" and month(m.fechaactuacion)="'.$mes.'" AND year(m.fechaactuacion)="'.$año.'" order by 1';
    //$sql='SELECT idInstalacion, i.ubicacion, fechaActuacion, observaciones, precio FROM mfo m JOIN instalaciones i ON m.idInstalacion=i.id WHERE month(m.fechaactuacion)="9" AND year(m.fechaactuacion)="2019"';
...
$app->get('/api/mfoespiras/imprimirnook/fechainspeccion/{a}/{b}',function(Request $request, Response $response){
    $mes= $request->getAttribute('a');
    $año= $request->getAttribute('b');

    $sql='SELECT count(fechaInspeccion) FROM mfoespiras m JOIN instalaciones i ON m.idInstalacion=i.id WHERE resolucion="false" and month(m.fechaactuacion)="'.$mes.'" AND year(m.fechaactuacion)="'.$año.'" order by 1';
    //$sql='SELECT idInstalacion, i.ubicacion, fechaActuacion, observaciones, precio FROM mfo m JOIN instalaciones i ON m.idInstalacion=i.id WHERE month(m.fechaactuacion)="9" AND year(m.fechaactuacion)="2019"';
...
});$app->get('/api/mfoespiras/imprimir/fechainspeccion/{a}/{b}',function(Request $request, Response $response){
    $mes= $request->getAttribute('a');
    $año= $request->getAttribute('b');

    $sql='SELECT count(fechaInspeccion) FROM mfoespiras m JOIN instalaciones i ON m.idInstalacion=i.id WHERE resolucion="true" and month(m.fechaactuacion)="'.$mes.'" AND year(m.fechaactuacion)="'.$año.'" order by 1';
    //$sql='SELECT idInstalacion, i.ubicacion, fechaActuacion, observaciones, precio FROM mfo m JOIN instalaciones i ON m.idInstalacion=i.id WHERE month(m.fechaactuacion)="9" AND year(m.fechaactuacion)="2019"';
